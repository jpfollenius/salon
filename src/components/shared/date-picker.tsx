  ...
  render() {
    ...
    return (      
      <div style={{...styles.layout, ...this.props.style}}>
        <Button style={styles.leftRounded} onClick={this.handleTodayClick} ><Icon icon="arrow-down" /></Button>
        <Button style={styles.notRounded} onClick={this.handlePreviousClick} ><Icon icon="arrow-left" /></Button>
        <ReactDatePicker
        ...
        />
        <Button style={styles.notRounded} onClick={this.handleNextClick} ><Icon icon="arrow-right" /></Button>
